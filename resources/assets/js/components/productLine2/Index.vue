<template>
        ...
        <div class="form-group" >
            ...
            <Tselect v-bind:nameelement="'producer_type_product_id'" v-bind:items="normalizeForSelectBox(this.elements, 'producer_type_product_id')" v-bind:defaultId="defaultLine" v-bind:placeholder="''"></Tselect>
        </div>
    </div>
</template>
<script>
